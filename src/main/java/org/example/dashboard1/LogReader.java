...
import java.io.*;
import ogr.example.dashboard1.LogParser;
...
public class LogReader {
    ...
    public static void readLogFile(String filePath) throws IOException {
        ...
        while((logLine=br.readLine())!=null)
        {
            ...
            org.example.dashboard1.LogRecordController.addLogRecord(logRecord);
        }

        // Puis on va traiter les lignes qui sont envoyées par Apache  au moment de l'ouverture de l'application en temps réel via la commande tail -f
